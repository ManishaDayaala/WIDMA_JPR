...
MAINFOLDER = r"D:\APPdata_WIDMA_Jaipur"

# Create other paths relative to the main folder
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_WIDMA.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_WIDMA.xlsx")  # DAILY DATA
...
def process_data():
    ...
    assets_list = [
        "Burnish Screw Rod Bearing(Pressure Head side)","Burnish Spindle DE","Burnish Spindle MDE",
        "Burnish Spindle MNDE","Burnish Spindle NDE","'Coolant Motor DE", "'Coolant Motor NDE",
        "Hydraulic MDE", "Hydraulic MNDE", "Hydraulic Pump DE", 
